...
const SLIDES_ES = [
  {
    icon: '🛠️',
    title: '¡Bienvenido a Changuinola Pro!',
    body: 'Encuentra técnicos confiables cerca de ti: electricistas, plomeros, técnicos en climatización y mucho más.',
  },
  {
    icon: '🔍',
    title: 'Busca o explora por categoría',
    body: 'Usa la barra de búsqueda o toca un ícono de categoría en el inicio para ver técnicos disponibles en Changuinola.',
  },
  {
    icon: '⭐',
    title: 'Perfiles verificados y reseñas reales',
    body: 'Cada técnico muestra su calificación, reseñas de clientes anteriores y, si está verificado, una insignia ✓.',
  },
  {
    icon: '📋',
...
const SLIDES_EN = [
  {
    icon: '🛠️',
    title: 'Welcome to Changuinola Pro!',
    body: 'Find trusted technicians near you: electricians, plumbers, HVAC technicians, and more.',
  },
  {
    icon: '🔍',
    title: 'Search or browse by category',
    body: 'Use the search bar or tap a category icon on the home screen to see available technicians in Changuinola.',
  },
  {
    icon: '⭐',
    title: 'Verified profiles and real reviews',
    body: 'Every technician shows their rating, reviews from past clients, and a ✓ badge if verified.',
  },
  {
    icon: '📋',
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: 4 }}>
          <button onClick={finish}
            style={{ background: 'none', border: 'none', color: th.textSec,
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          ...
          <button onClick={() => isLast ? finish() : setIndex(i => i + 1)}
            style={{ flex: index > 0 ? 1 : undefined, width: index === 0 ? '100%' : undefined,
