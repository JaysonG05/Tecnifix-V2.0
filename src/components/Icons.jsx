// ============================================================
//  Icons.jsx — Sistema de iconos SVG de TECNIFIX
//  Basado en Heroicons (stroke outline, 24px viewBox)
//  Uso: <Icon name="home" size={20} color={th.primary} />
// ============================================================
...
const PATHS = {
    ...
    'star-filled': <path strokeLinecap="round" strokeLinejoin="round" fill="currentColor" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.562.562 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />,
    ...
    'check-badge': <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 01-.865 3.48 3.745 3.745 0 01-3.48.865A3.735 3.735 0 0112 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 01-3.48-.865 3.746 3.746 0 01-.865-3.48A3.735 3.735 0 013 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 01.865-3.48 3.745 3.745 0 013.48-.865A3.735 3.735 0 0112 3c1.268 0 2.39.63 3.068 1.593a3.745 3.745 0 013.48.865 3.745 3.745 0 01.865 3.48A3.735 3.735 0 0121 12z" />,
    ...
    money: <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />,
    ...
    'wifi-off': <path strokeLinecap="round" strokeLinejoin="round" d="M16.72 11.06A10.94 10.94 0 0119 12.55M5 6.71A10.95 10.95 0 013.02 9.59a10.95 10.95 0 007.17 7.17M10.71 5A10.94 10.94 0 0118 7.45M1 1l22 22M9.58 14.76A5.252 5.252 0 0112 14.25a5.25 5.25 0 013.17 1.04M12 18.75l.53.53a.75.75 0 01-1.06 0l.53-.53z" />,
    ...
    dispute: <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z" />,
...
// Componente de ícono con contenedor cuadrado (para menús, cards, etc.)
export function IconBox({ name, size = 20, color, bg, boxSize = 38, radius = 10 }) {
    return (
        <div style={{
            width: boxSize, height: boxSize, borderRadius: radius, flexShrink: 0,
            background: bg || 'rgba(0,83,160,0.1)',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
        }}>
            <Icon name={name} size={size} color={color || '#0053A0'} />
        </div>
    )
}
