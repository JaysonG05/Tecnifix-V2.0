...
const DEFAULT_COLORS = ["#0080FF", "#00B366", "#FFCC00", "#FF8800", "#FF3300"];
const BAND_HALF = 17;
const SWEEP_START = -BAND_HALF;
const SWEEP_END = 100 + BAND_HALF;
const TEXT_SWAP_EASE = [0.22, 1, 0.36, 1];
...
function measureWidths(element, texts) {
...
const DiaTextReveal = forwardRef(
  (
    {
      text,
    ...
    return (
      <motion.span
        ...
        className={`${componentThemeClassName} align-bottom text-inherit ${className || ""}`.trim()}
        ref={setRefs}
      ...
      >
        <motion.span
          aria-hidden
          className="inline-block text-inherit leading-[inherit]"
          style={contentStyle}
        >
          {texts[activeIndex]}
        </motion.span>
